...
stopwords = nltk_stopwords + ['course', 'topics', 'students', 'learning', 'science', 'methods', 'cs', 'tools', 'concepts', 'issues', 'type', 'emphasis', 'seminar', 'world', 'areas', 'work', 'introduction', 'assignments', 'assignment']
